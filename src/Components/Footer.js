...
function Footer() {
    ...
    const handleSubmit = (event) => {
        ...
        fetch('https://email-1fdcf-default-rtdb.firebaseio.com/sendbox.json',
            {
                method : 'POST',
        ...
        <div className='upper'>
            <div className='header'>
                ...
                <div className='fb'>
                    ...
                    <svg className='ico' width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg className='ico' width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='mid'>
                ...
                <div className='row'>
                    <p className='hi'>Get In Touch</p>
                    
                    <div className='input'>
                        <form onSubmit={handleSubmit}>
                            <input type='text' placeholder='Your Email' className="inp" onChange={handleEmailChange}/>
                            <button className='bot' type='submit'>Subscribe</button>
                        </form>
                    </div>
                    
                    <p className='p5'>Lorem impsum mail data...</p>
                </div>
            </div>
        </div>
        <div className='foot'>
            <p className='fo'>Made With &#10084;&#65039; at AccioJob</p>
        </div>
    </div>
  )
}
